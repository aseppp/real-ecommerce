...
const CardProduct = () => {
  return (
    <>
      <div className="grid gap-y-8 grid-cols-2 grid-rows-3 place-items-center md:grid-cols-4 md:grid-rows-4 py-5">
        <div className="max-w-base md:max-w-xxs bg-white rounded-lg shadow dark:bg-darkBg dark:border-gray-700 shadow-bottom">
          ...
          <div className="px-2 mt-2">
            <Link href={`/product/view/${1}`}>
              <h5 className="text-sm md:text-lg tracking-tight text-gray-900 dark:text-white">
                Iphone 12 Pro Max
              </h5>
            </Link>
          </div>
